...
public class BankController {
    ...
    /**
     * Перевод денег.
     * @param body тело запроса с полями:
     *             Счёт с которого переводят деньги
     *             srcPassport   - данные паспорта
     *             srcRequisite  - реквезиты счёта
     *             Счёт куда переводят деньги
     *             destPassport  - данные паспорта
     *             destRequisite - реквезиты счёта
